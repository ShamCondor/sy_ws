...
if("TRUE" STREQUAL "TRUE")
  set(rotate_recovery_SOURCE_PREFIX /home/ares/sy_ws/src/navigation/rotate_recovery)
  set(rotate_recovery_DEVEL_PREFIX /home/ares/sy_ws/devel)
  ...
  set(rotate_recovery_INSTALL_PREFIX /home/ares/sy_ws/install)
...
if(NOT "/home/ares/sy_ws/src/navigation/rotate_recovery/include " STREQUAL " ")
  set(rotate_recovery_INCLUDE_DIRS "")
  set(_include_dirs "/home/ares/sy_ws/src/navigation/rotate_recovery/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotate_recovery' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ares/sy_ws/src/navigation/rotate_recovery/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
